...
registerCompanyIcons({
  orangewood: {
    ...
    sizeClassName: "h-[0.9rem] w-[5.4rem]",
  },
  zs: { icon: ZsIcon, sizeClassName: "h-6 w-[1.92rem]" },
  uw: { icon: UwIcon, sizeClassName: "h-[0.9rem] w-[1.35rem]" },
  intuit: { icon: IntuitIcon, sizeClassName: "h-3 w-[3.6rem]" },
  birla: {
    icon: maskIcon("/logos/birla-ai-labs.png"),
    sizeClassName: "h-[1.05rem] w-[1.68rem]",
  },
  truu: { icon: TruuIcon, sizeClassName: "h-[1.05rem] w-[1.32rem]" },
})
